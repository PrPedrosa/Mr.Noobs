class EnemyLaser {
	constructor(ctx) {
		...
		this.laserImgSrc = [
			"assets/images/laserRed.png",
			"assets/images/laserRedUp.png"
		]
	...
	bottomPos() {
		if (this.identifyPos === "startsTop" || this.identifyPos === "startsBottom")
			return this.position[1] + 400
	...
	rightPos() {
		if (this.identifyPos === "startsLeft" || this.identifyPos === "startsRight")
			return this.position[0] + 400
